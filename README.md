...
> **当前功能版本：V0.0.16**（2026-07-17）

以 **项目** 为中心，围绕 **品牌套件 / 素材库 / 模板库 / AI 工作台 / 生成图** 组织品牌广告物料的生成、修改与归档。品牌套件由 **logo / 字体 / 颜色 / 设计指南 / 图像 / 品牌指南** 6 个维度组成。V0.0.16 在 V0.0.15 的 Lovart 式工作台与品牌套件预览基础上，修复 AI 工作台 URL/草稿残留旧项目 ID 时提交出图报错的问题。
