...
> **当前功能版本：V0.0.15**（2026-07-17）

以 **项目** 为中心，围绕 **品牌套件 / 素材库 / 模板库 / AI 工作台 / 生成图** 组织品牌广告物料的生成、修改与归档。品牌套件由 **logo / 字体 / 颜色 / 设计指南 / 图像 / 品牌指南** 6 个维度组成。V0.0.15 在 V0.0.14 的 Lovart 式画布第一阶段基础上，进一步简化 AI 工作台右侧为对话记录与输入框，并优化品牌套件的图片化预览、PDF 上传与自动解析体验。
